...
class PulseSocialGraphUser {
  const PulseSocialGraphUser({
    required this.id,
    required this.username,
    required this.displayName,
    required this.isFollowing,
  ...
  factory PulseSocialGraphUser.fromJson(Map<String, dynamic> json) {
    final isFollowedByCurrentUser = json['isFollowedByCurrentUser'];

    if (isFollowedByCurrentUser is! bool) {
      throw const FormatException(
        'isFollowedByCurrentUser alanı geçerli değil.',
      );
    }

    return PulseSocialGraphUser(
      id: _requiredInt(json, const ['id']),
      username: _requiredString(json, const ['username']),
      displayName: _requiredString(json, const ['displayName']),
      avatarUrl: _optionalString(json['avatarUrl']),
